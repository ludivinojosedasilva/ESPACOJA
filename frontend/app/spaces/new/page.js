...
export default function NewSpace() {
  ...
  async function handleSubmit(e) {
    ...
    try {
      ...
      if (!res.ok) {
        alert(data.message || "Erro ao criar espaco");
        return;
      }

      alert("Espaco criado com sucesso!");
        ...
        <div className="bg-white rounded-2xl shadow p-8">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <button
              type="submit"
              disabled={submitting}
              className="w-full bg-green-600 hover:bg-green-700 disabled:bg-green-300 text-white font-bold p-4 rounded-xl transition text-lg"
            >
              {submitting ? "Cadastrando..." : "Cadastrar Espaco"}
            </button>
